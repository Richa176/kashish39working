...
var jumpSound , checkPointSound, dieSound
  ...
  function preload(){
    trex_running = loadAnimation("p1.png","p2.png","p3.png");
  ...
  function setup() {
   ...
   console.log(message)
    ...
    ground = createSprite(200,displayHeight-320,400,20);
  ...
  function spawnObstacles(){
   if (frameCount % 60 === 0){
     var obstacle = createSprite(displayWidth-500,displayHeight-430,10,80);
